...
export function SubmitButton({
    ...
    return (
        <button
            type="button"
            className="w-full border-white rounded bg-blue-700 p-3 text-white"
            onClick={onClick}
            {...rest}
        >
            {children}
...
export function DangerButton({children, onClick, ...rest}: ButtonProps) {
    return (
        <button
            onClick={onClick}
            className="w-full border-white rounded bg-red-700 p-3 text-white"
            {...rest}
        >
            {children}
        </button>
